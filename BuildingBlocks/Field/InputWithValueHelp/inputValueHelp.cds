...
entity OrgLevelVH {
  ...
  key ID            : String;
      ...
      nodeType      : String;
      Superordinate : Association to OrgLevelVH
                        on Superordinate.ID = parent;
      RootEntity    : Association to RootEntity
                        on RootEntity.ID = RootEntityID;
};
...
annotate RootEntity with {
  propWithTreeTableVH @(Common: {
    Label    : 'Org Level',
    ValueList: {
      Label                       : 'Org Level',
      CollectionPath              : 'OrgLevelVH',
      Parameters                  : [{
        $Type            : 'Common.ValueListParameterInOut',
        LocalDataProperty: propWithTreeTableVH,
...
service Service {
  ...
  entity OrgLevelVH              as projection on core.OrgLevelVH;
